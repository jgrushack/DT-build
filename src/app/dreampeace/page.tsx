...
// Placeholder Ambient Albums (from dreampeace.net research)
// Using real album titles but a placeholder Audius track for audio
...
const DREAMPEACE_ALBUMS: Playlist[] = [
    {
        id: 'dp1',
        name: 'Tryptophan',
