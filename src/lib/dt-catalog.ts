...
export const DT_ALBUMS: Playlist[] = [
    album('ocean-machine', 'Ocean Machine: Biomech', 'Townsend\'s breakthrough solo work — progressive metal with ambient textures and soaring melodies about loss, hope, and transcendence.', null, 1997, 'Progressive Metal', 45000, [
    ...
    album('infinity', 'Infinity', 'A manic, psychedelic wall-of-sound record born from intense creative frenzy. Dense layering and unconventional structures.', null, 1998, 'Progressive Metal', 32000, [
    ...
    album('physicist', 'Physicist', 'Aggressive, industrial-tinged metal recorded with the Strapping Young Lad lineup. Raw intensity through signature production.', null, 2000, 'Industrial Metal', 28000, [
    ...
    album('terria', 'Terria', 'An expansive, nature-inspired progressive metal epic evoking the vast Canadian landscape. Cinematic and deeply emotional.', null, 2001, 'Progressive Metal', 52000, [
    ...
    album('accelerated-evolution', 'Accelerated Evolution', 'The first Devin Townsend Band album. More song-oriented and accessible, with a balance of ambient passages and heavy riffs.', null, 2003, 'Progressive Metal', 38000, [
    ...
    album('synchestra', 'Synchestra', 'A concept album about interconnectedness — the last track loops into the first. Intricate arrangements and orchestral elements.', null, 2006, 'Progressive Rock', 30000, [
    ...
    album('ziltoid', 'Ziltoid the Omniscient', 'A comedic sci-fi concept album about an alien puppet demanding the universe\'s ultimate cup of coffee. Progressive metal meets theatrical absurdity.', null, 2007, 'Progressive Metal', 42000, [
    ...
    album('ki', 'Ki', 'The first album in the four-part quadrology. Deliberately restrained, quiet, and introspective — exploring dynamics, space, and subtlety.', null, 2009, 'Progressive Rock', 35000, [
    ...
    album('addicted', 'Addicted', 'The polar opposite of Ki — joyful, hook-driven pop-metal featuring Anneke van Giersbergen. Catchy, upbeat, and unapologetically fun.', null, 2009, 'Pop Metal', 55000, [
    ...
    album('deconstruction', 'Deconstruction', 'Townsend\'s heaviest, most complex solo work. A maximalist progressive metal opera about existence featuring a full orchestra and guest vocalists.', null, 2011, 'Progressive Metal', 48000, [
    ...
    album('ghost', 'Ghost', 'The final quadrology album — Townsend\'s most gentle and ambient work. Ethereal, meditative, and dreamlike with no metal elements.', null, 2011, 'Ambient', 40000, [
    ...
    album('epicloud', 'Epicloud', 'Triumphant, anthemic arena-rock featuring Anneke van Giersbergen. Deliberately uplifting with massive choruses — Townsend\'s most accessible record.', null, 2012, 'Progressive Rock', 58000, [
    ...
    album('casualties-of-cool', 'Casualties of Cool', 'A haunting side project blending ambient, country, and blues. Dark, spacious, and cinematic — like a ghostly desert soundtrack.', null, 2014, 'Ambient Country', 25000, [
    ...
    album('z-squared', 'Z²', 'An ambitious double album: Sky Blue (melodic pop-metal with Anneke) and Dark Matters (the Ziltoid sequel). Spans Townsend\'s full range.', null, 2014, 'Progressive Metal', 36000, [
    ...
    album('transcendence', 'Transcendence', 'The final Devin Townsend Project album. Lush, orchestral progressive metal blending heaviness with ethereal beauty.', null, 2016, 'Progressive Metal', 44000, [
    ...
    album('empath', 'Empath', 'Townsend\'s most genre-defying work — from brutal metal to Disney orchestral to new age, sometimes within a single song. The 23-minute "Singularity" suite is a career-defining epic.', null, 2019, 'Progressive Metal', 62000, [
    ...
    album('the-puzzle', 'The Puzzle', 'An eclectic, experimental singer-songwriter album with short-form compositions jumping between genres. Quirky, intimate, and unpredictable.', null, 2021, 'Art Rock', 18000, [
    ...
    album('snuggles', 'Snuggles', 'A seamless ambient/new-age record designed as a continuous listening experience. Gentle, meditative, and flowing.', null, 2021, 'Ambient', 22000, [
    ...
    album('lightwork', 'Lightwork', 'A return to song-oriented, accessible progressive rock. Warm, melodic, and polished — mature, focused writing after years of experimental sprawl.', null, 2022, 'Progressive Rock', 34000, [
    ...
    album('powernerd', 'PowerNerd', 'Deliberately straightforward, riff-driven hard rock. Short songs, big hooks, minimal experimentation — a love letter to the joy of loud guitar music.', null, 2024, 'Hard Rock', 50000, [
